...
def basic_range():
    ...
    and iterates through the for loop 0 to 9
...
def other_range():
    ...
    value must be smaller than the stop for positive values.
...
def example_else():
    """ This While loop uses an else statement
    to perform a block once the loop ends. The else
